<template>
  ...
  >
    <v-card>
      <v-form>
        <v-toolbar dark>
          <v-toolbar-title>Nueva vacante</v-toolbar-title>
          <v-spacer></v-spacer>
          <v-toolbar-items>
          ...
          <v-stepper v-model="step" show-actions elevation="0">
            ...
            <v-stepper-window>
              <v-stepper-window-item :value="1">
                ...
                <v-col class="my-5" cols="12" md="12">
                  <v-row justify="space-between">
                    <v-spacer></v-spacer>
                    <v-btn color="success" @click="next">Siguiente</v-btn>
                  </v-row>
                </v-col>
              ...
              <v-stepper-window-item :value="2">
                <v-row>
                  <v-col cols="12" md="12">
                    <label>Seleccione las prestaciones que ofrece:</label>
                  </v-col>
                  <v-col cols="12" md="6">
                    <v-checkbox
                ...
                <v-col class="my-5" cols="12" md="12">
                  <v-row justify="space-between">
                    <v-btn color="primary" @click="back">Atrás</v-btn>
                    <v-btn color="success" @click="next">Siguiente</v-btn>
                  </v-row>
                </v-col>
              </v-stepper-window-item>
